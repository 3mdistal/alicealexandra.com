...
export const STUDIO_NEWS: NewsEntry[] = ([
	...
	},
	{
		...
		segments: [
			{ type: 'text', text: 'Edited hymn: ' },
			{ type: 'link', text: '“i used to think the roots of all the corn on earth”', href: '/studio/hfc' },
			{ type: 'text', text: '' }
		]
	},
	{
	...
	},
	{
		...
		segments: [
			{ type: 'text', text: 'New hymn: ' },
			{ type: 'link', text: '“on watching another family watch the solar eclipse”', href: '/studio/hfc' },
			{ type: 'text', text: '' }
		]
	},
	{
...
] satisfies NewsEntry[]).sort((a, b) => b.date.localeCompare(a.date));
