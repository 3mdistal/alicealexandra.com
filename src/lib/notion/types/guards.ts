...
export function isListItemBlock(
	...
	return isBlockType(block, 'bulleted_list_item') || isBlockType(block, 'numbered_list_item');
}
...
export function isCodeBlock(
	block: BlockObjectResponse | PartialBlockObjectResponse
): block is BlockObjectResponse & { type: 'code' } {
...
export function isSyncedBlock(
	block: BlockObjectResponse | PartialBlockObjectResponse
): block is BlockObjectResponse & { type: 'synced_block' } {
...
export function isTableBlock(
	block: BlockObjectResponse | PartialBlockObjectResponse
): block is BlockObjectResponse & { type: 'table' } {
 ...
 */
export function isTableRowBlock(
	block: BlockObjectResponse | PartialBlockObjectResponse
): block is BlockObjectResponse & { type: 'table_row' } {
